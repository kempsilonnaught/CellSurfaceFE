...
void FourthOrder::assemble(double sigma, double kappa, double kappabar){
	...
	VectorTools::interpolate_boundary_values(doffer, 5, ConstantFunction<2>(250), boundary_values);
	VectorTools::interpolate_boundary_values(doffer, 6, ConstantFunction<2>(250), boundary_values);
